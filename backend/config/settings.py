...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {
        ...
        "auth": "5/minute" if not DEBUG else "1000/minute",
        "email_verification": "3/minute" if not DEBUG else "1000/minute",
        "reactivation": "3/hour" if not DEBUG else "1000/hour",
        "password_reset": "3/hour" if not DEBUG else "1000/hour",
    },
...
GCS_BUCKET_NAME = os.environ.get("GCS_BUCKET_NAME", "re-use-iteso")
