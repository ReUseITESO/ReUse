...
USERS = [
    {
        ...
        "email": "lucia.fernandez@iteso.mx",
        "phone": "3311223344",
    },
    {
        "name": "Carlos Rodríguez Torres",
        "email": "carlos.rodriguez@iteso.mx",
        "phone": "3322334455",
    },
    {"name": "Ana García López", "email": "ana.garcia@iteso.mx", "phone": "3333445566"},
    {
        "name": "Miguel Hernández Ruiz",
        "email": "miguel.hernandez@iteso.mx",
        "phone": "3344556677",
    },
    {
        "name": "Sofía Martínez Castro",
    ...
    def handle(self, *args, **kwargs):
        ...
        for (
            ...
            if not category or not seller:
                self.stdout.write(
                    self.style.WARNING(
                        f"  ⚠ Skipped '{title}': category or seller not found."
                    )
                )
                continue
