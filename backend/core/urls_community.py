...
urlpatterns = [
    ...
    path(
        "<int:pk>/members/",
        views.CommunityMembersView.as_view(),
        name="community-members",
    ),
    path(
        "<int:pk>/invite/", views.CommunityInviteView.as_view(), name="community-invite"
    ),
    ...
    path(
        ...
        views.CommunityExpelView.as_view(),
        name="community-expel",
    ),
    path("<int:pk>/posts/", views.CommunityPostsView.as_view(), name="community-posts"),
    path(
        "<int:pk>/posts/<int:post_id>/",
